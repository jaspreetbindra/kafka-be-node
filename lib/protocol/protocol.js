  ...
  function decodePartitions (end, vars) {
    ...
    this.word32bs('partition')
      ...
      .tap(function (vars) {
        ...
        if(vars.highWaterOffset !== null
          && vars.highWaterOffset !== undefined
          && vars.partition !== null
          && vars.partition !== undefined
        && vars.messageSet.length > 0) {
          beOverrideLogger.log("Got request for topic "+ vars.topic + " parition "+ vars.partition + " highWaterOffset" + vars.highWaterOffset);
        }
